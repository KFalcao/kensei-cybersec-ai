...
if altura <= 0 or peso <= 0:
    ...
    ranges = [
        {"category": "Abaixo do peso", "start": 10, "end": 18.5, "color": "#4da6ff"},
    ...
    base = alt.Chart(df).mark_bar().encode(
        ...
        color=alt.Color('category:N', scale=alt.Scale(domain=df['category'].tolist(), range=df['color'].tolist()), legend=None)
